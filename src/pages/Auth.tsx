    ...
    try {
      const { error } = await supabase.auth.signUp({
        ...
        options: {
          ...
          data: { full_name: fullName, phone, role, address, bio },
        },
      });
      if (error) throw error;
          ...
          {mode === "signup" && (
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              {signupStep === 2 && (
                <>
                  <div>
                    <Label className="text-xs font-semibold text-muted-foreground mb-1.5 block">I am a...</Label>
                    <Select value={role} onValueChange={setRole} required>
                      <SelectTrigger className="rounded-xl h-12">
                        <SelectValue placeholder="Select your role" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="parent">Parent / Employer</SelectItem>
                        <SelectItem value="helper">Helper / Domestic Worker</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div>
                  ...
                  <div>
                    <Label className="text-xs font-semibold text-muted-foreground mb-1.5 block">Short Bio</Label>
                    <Textarea
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <label htmlFor="terms" className="text-xs text-muted-foreground leading-relaxed">
                      I agree to the <span className="text-primary font-semibold">Terms of Service</span> and <span className="text-primary font-semibold">Privacy Policy</span>. I consent to ID verification for trust and safety.
                    </label>
                  </div>
